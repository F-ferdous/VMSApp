...
const Musak63Reports = () => {
  ...
  const getData = () => {
    const q = query(collection(db, "SalesEntry"));
    ...
    <section className="w-full flex flex-col items-center justify-center mt-2 p-2 mx-5">
      <div className="bg-gray-100 w-[90%] pb-5">
        <div className="bg-gradient-to-tl from-sky-400 to-sky-800 p-2 flex justify-between items-center">
          <h1 className="text-white text-sm font-bold">Sales Entry List</h1>
          <button
          ...
          <table className="w-[90%] items-center m-auto mt-2 text-left   border-collapse border border-gray-400">
            <thead className="text-md text-gray-50 uppercase bg-gradient-to-l from-sky-500 via-violet-500 to-pink-500">
              <tr>
                ...
                <th className="p-2 border border-gray-400">Total With Vat</th>
                  ...
                  <tr className="text-gray-900">
                    ...
                    <td className="p-2 border border-gray-400 ">
                      <button
                        ...
                        onClick={() =>
                          navigate(`/SalesEntryReportView/${item.id}`)
                        }
                      >
                        <AiFillEdit />
                      </button>
