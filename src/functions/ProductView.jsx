    ...
    <section className="w-full flex flex-col items-center justify-center mt-2 p-2 mx-5">
      <div className="bg-gray-100 w-[90%] pb-5">
        <div className="bg-gradient-to-tl from-sky-400 to-sky-800 p-2 flex justify-between items-center">
          <h1 className="text-white text-sm font-bold">Products List</h1>
          <button
          ...
          <table className="w-[90%] items-center m-auto mt-2 text-xs text-left   border-collapse border border-gray-400">
            <thead className="text-xs text-gray-50 uppercase bg-gradient-to-l from-sky-500 via-violet-500 to-pink-500">
              <tr>
                ...
                <th className="p-2 border border-gray-400">SD Rate</th>
                ...
                <th className="p-2 border border-gray-400">Model</th>
                <th className="p-2 border border-gray-400">Packet Size</th>
                <th className="p-2 border border-gray-400">Packet Quantity</th>
              </tr>
            </thead>
            <tbody>
              {Data &&
                Data.map((item, index) => (
                  <tr className="text-gray-900">
                    ...
                    <td className="p-2 border border-gray-400">{item.Uom}</td>
                    <td className="p-2 border border-gray-400">{item.Model}</td>
                    <td className="p-2 border border-gray-400">
                      {item.PackSize}
                    </td>
                    <td className="p-2 border border-gray-400">
